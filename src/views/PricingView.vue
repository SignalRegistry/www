...
<style>
html.theme-dark .plan-compare-card {
  background: #101225;
  border-color: #262944;
  box-shadow: none;
}

html.theme-dark .plan-compare-table th,
html.theme-dark .plan-compare-table td {
  border-color: #2e3150;
  color: #d3d6f5;
}

html.theme-dark .plan-compare-table thead th {
  background: #1a1d35;
  color: #ffffff;
}

html.theme-dark .plan-compare-table tbody th,
html.theme-dark .plan-compare-table tbody td {
  background: #101225;
}

html.theme-dark .plan-compare-table tbody tr:nth-child(even) th,
html.theme-dark .plan-compare-table tbody tr:nth-child(even) td {
  background: #141833;
}

html.theme-dark .plan-compare-table .section-row td {
  background: #181b31;
  color: #b6baf1;
}

html.theme-dark .plan-compare-table .column-title {
  color: #ffffff;
}

html.theme-dark .plan-compare-table .column-subtitle {
  color: #9da4dd;
}

html.theme-dark .plan-compare-table .compare-dash {
  color: #7c80ad;
}

html.theme-dark .plan-compare-note {
  color: #a3aadf;
}

html.theme-dark .plan-compare-note a {
  color: #b7b0ff;
}
</style>