var equations = [
  ...
  {
    category: "antenna",
    title: "Radiation resitance of small loop antenna",
    formula: "R_r = 31171 \\times N^2 \\dfrac{\\footnotesize S^2}{\\footnotesize \\lambda^4} \\quad [\\Omega]",
    args: [
      { id: "N", sym: "N", def: "\\textit{Number of turns}" },
      { id: "S", sym: "S", def: "\\textit{Interior area of loop}\\phantom{d}[m^2]" },
      { id: "lambda", sym: "\\lambda", def: "\\textit{Wavelength}\\phantom{d}[m]" },
    ],
    yields: [
      { id: "Rr", sym: "R_r", def: "\\textit{Radiation resistance}\\phantom{d}[\\Omega]", format: function (number) { return number.toFixed(6) } },
    ],
    calc: {
      labelWidth: "65px",
      vars: { N: 1, S: 1, lambda: 1 },
      expr: ["N*S*S/(lambda*lambda*lambda*lambda)"]
    }
  },
  {
    category: "propagation, antenna",
